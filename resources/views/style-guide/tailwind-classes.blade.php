{{-- BG Colors --}}
<div class="bg-slate-50 bg-slate-100 bg-slate-200 bg-slate-300 bg-slate-400 bg-slate-500 bg-slate-600 bg-slate-700 bg-slate-800 bg-slate-900 bg-slate-950"></div>
...
{{-- text Colors --}}
<div class="text-slate-50 text-slate-100 text-slate-200 text-slate-300 text-slate-400 text-slate-500 text-slate-600 text-slate-700 text-slate-800 text-slate-900 text-slate-950"></div>
...
{{-- Text Sizes --}}
<h1 class="text-black dark:text-gray-100 pt-4 mb-4 font-semibold leading-tight text-3xl"></h1>
<h2 class="text-black dark:text-gray-100 pt-4 mb-4 font-semibold leading-tight text-2xl"></h2>
<h3 class="text-black dark:text-gray-100 pt-4 mb-4 font-semibold leading-tight text-xl"></h3>
<h4 class="text-black dark:text-gray-100 pt-4 mb-4 font-semibold leading-tight text-lg"></h4>
<h5 class="text-black dark:text-gray-100 pt-4 mb-4 font-semibold leading-tight text-base"></h5>
<h6 class="text-black dark:text-gray-100 pt-4 mb-4 font-semibold leading-tight text-sm"></h6>
